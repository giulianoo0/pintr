...
// consumeImageStream reads the Codex SSE stream and returns the latest
// (finally the complete) image bytes. Partial images overwrite earlier ones,
// so the last one is the finished render.
